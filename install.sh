...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210122042-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Wednesday, Oct 12, 2022 20:42 EDT
# @@File             :  install.sh
# @@Description      :
...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/bun"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="bun"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/bun"
APPDIR="$HOME/.local/share/srv/docker/bun"
DATADIR="$HOME/.local/share/srv/docker/bun/files"
...
CONTAINER_HTTP_PORT="19051:3000"
